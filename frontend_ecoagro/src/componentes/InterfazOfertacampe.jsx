...
<div>
    ...
    <div>
        <h1 className="component-1-text development-ofertascampe titulobody-ofertascampe shadow p-3 mb-5 bg-whiteverdecitovalor rounded Titulocompradorterceraparte" >Tus Ofertas</h1>
