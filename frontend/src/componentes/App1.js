...
<h1 className="shadow p-3 mb-5 bg-whiteverdecitovalor rounded Titulocompradorterceraparte">A continuación te mostraremos los productos que estan en mayor tendencia</h1></div>
  <div  className="UBICACION ">
        ...
        <div className="card0pantalladevalor mb-5 " >
          <div className="row no-gutters">
            <div className="col-md-8 tamaño">
              <img src={FRUTA1} className="card-img" alt="Responsive image" />
            </div>
            <div className="col-md-4">
              <div className="card-body">
                ...
                <p className="card-text pnatlladeproductosvalor"><button type="button" className="btn btn-inf btn btn-outline-warning">Más info</button></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card0pantalladevalor mb-5" >
          <div className="row no-gutters">
            <div className="col-md-8 tamaño">
              <img src={FRUTA2} className="card-img" alt="Responsive image" />
            </div>
            <div className="col-md-4">
              <div className="card-body">
        ...
        <div className="cardin2pantalladevalor card0pantalladevalor mb-5" >
          <div className="row no-gutters">
            <div className="col-md-8 tamaño">
              <img src={FRUTA3} className="card-img" alt="Responsive image" />
            </div>
            <div className="col-md-4">
              <div className="card-body">
                <h5 className="card-title">Sandia</h5>
                <p className="card-text pnatlladeproductosvalor">Producto porcedente de nuestra región pacifica colombiana.</p>
                <p className="card-text pnatlladeproductosvalor"><button type="button" className="btn btn-inf btn btn-outline-warning">Más info</button></p>
              </div>
            </div>
          </div>
        </div>
        <div className="cardin3pantalladevalor card0pantalladevalor mb-5" >
          <div className="row no-gutters">
            <div className="col-md-8 tamaño">
              <img src={FRUTA4} className="card-img" alt="Responsive image" />
            </div>
            <div className="col-md-4">
              <div className="card-body">
                <h5 className="card-title">Guayaba</h5>
                <p className="card-text pnatlladeproductosvalor">Producto procedente d enuestra región Caribe</p>
                <p className="card-text pnatlladeproductosvalor"><button type="button" className="btn btn-inf btn btn-outline-warning">Más info</button></p>
              </div>
            </div>
          </div>
...
<h2 className="SUBTITULO">Somos el enlace directo entre el campesino y el comprador</h2>
  ...
  <div class="card">
    <img src="https://static.nationalgeographicla.com/files/styles/image_3200/public/NewZealand_Ep104_GordonRamsayUncharted_UNG07545_CSI.jpg?w=710&h=1065" class="card-img-top" alt="Responsive image"/>
    <div class="card-body">
  ...
  <div class="card">
    <img src="https://static.nationalgeographicla.com/files/styles/image_3200/public/wet-markets-gettyimages-1197116072.jpg?w=1600&h=900" class="card-img-top" alt="Responsive image"/>
    <div class="card-body">
  ...
  <div class="card">
    <img src="https://static.nationalgeographicla.com/files/styles/image_3200/public/Peru_Ep101_GordonRamsayUncharted_EBS7042_CSI.jpg?w=710&h=473" class="card-img-top uli" alt="Responsive image"/>
  </div>
...
<div class="cardin3pantalladevalor row row-cols-1 row-cols-md-2 Noticias">
  <div class="col mb-4">
    <div class="card0pantalladevalor">
      <img src="https://static.nationalgeographicla.com/files/styles/image_3200/public/food_consumption_GettyImages-498489688.jpg?w=1600&h=900" class="card-img-top uli" alt="Responsive image"/>
      <div class="card-body">
  ...
  <div class="col mb-4">
    <div class="card0pantalladevalor">
      <img src="https://www.minagricultura.gov.co/noticias/PublishingImages/Foto%20MinAgricultura%20proyecto%20de%20ley%20de%20palma%208%20de%20septiembre%202020%20web.jpeg" class="card-img-top uli" alt="Responsive image"/>
      <div class="card-body">
  ...
  <div class="col mb-4">
    <div class="card0pantalladevalor">
      <img src="https://www.minagricultura.gov.co/noticias/PublishingImages/Foto%20MinAgricultura%20Rodolfo%20Zea%20Navarro%20-%20Programa%20presidente%20-%20septiembre%203%20de%202020%20web.jpeg" class="card-img-top uli" alt="Responsive image"/>
      <div class="card-body">
