...
<div class="card-columns">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text pepito">Todos los productos llegaron en excelente estado y con el tiempo y dinero acordado.</p>
    </div>
  </div>
  <div class="card p-3">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Opinion por:</h5>
      <p class="card-text pepito">El servicio y el cuidado atento de todo el proceso fue excelente.</p>
  ...
  <div class="card text-center">
    <div class="card-body">
      ...
      <p class="card-text pepito">Si haz quedado satisfecho prueba otros de los servicios de nuestras App y recomiendasela a tus amigos.</p>
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Opinion por:</h5>
      <p class="card-text pepito">Muy buen servicio, pero se tuvo que insistir en la llegada el producto, tardo más de lo estipulado.</p>
      <p class="card-text"><small class="text-muted"></small></p>
    </div>
  </div>
</div>
...
<div class="card COL">
  ...
  <div class="card-body ">
    ...
    <p class="card-text pepito">Un hongo que ha causado estragos en las plantaciones de banano en el hemisferio oriental, a pesar de años de esfuerzos preventivos, llegó a las Américas.
...
El descubrimiento del hongo representa un desastre potencial inminente para los bananos como fuente de alimento y como producto de exportación. La enfermedad de Panamá Tropical Race 4 —o TR4— es una infección de la planta de banano por un hongo del género Fusarium . Aunque los plátanos producidos en suelo infectado no son peligrosos para los humanos, las plantas infectadas eventualmente dejan de dar frutos.</p>
   ...
   <p class="card-text tamñoparrafovalor pepito">ALGO SE ESTÁ GESTANDO en el pequeño pueblo colombiano de Minca. Huele a caramelo, corteza, carbón y chocolate. ¿La fuente? Granos de café, recién salidos de los tostadores del jardín, con su fuerte olor a quemado atravesando la húmeda neblina tropical.
