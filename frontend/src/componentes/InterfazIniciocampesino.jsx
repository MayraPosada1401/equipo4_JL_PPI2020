...
import '../Estilos/EstiloIniciocampesino.css'
import campe from '../Imagenes/campe.png';

export default function InterfazInicioCampesino() {
  ...
  return (
    <div className="InterfazInicioCampesino">
      ...
      <div  className="cards-inicio-cursos-campe flex-md-equal">
        
        <div className="card0-inicio mb-5" >
          <div className="row no-gutters">
            <div className="col-md-8">
              <img src="https://medlineplus.gov/images/Pesticides.jpg" className="card-img-top-inicio" alt="..." />
            </div>
        ...
        <div className="card0-inicio mb-5" >
          <div className="row no-gutters">
            <div className="col-md-8">
              <img src="https://www.kienyke.com/sites/default/files/styles/amp_1200x675_16_9/public/wp-content/uploads/2017/11/mercando-campesinos.jpg?itok=IF0_jVLP" className="card-img-top-inicio" alt="..." />
            </div>
            <div className="col-md-4">
              <div className="card-body">
      ...
      <div className="card1-body mb-3">
        <img src="https://imgcdn.larepublica.co/i/480/2020/01/30144722/EPikHWzVUAAx7VX.jpg" className="card-img2-top-inicio" alt="..."/>
          <div className="card-body">
