...
export default function InterfazMaterialCursoCampe() {
    ...
    <div className="MaterialCursoCampe">
        ...
        <div className="blog-main">
          ...
          <div className="blog-post-1-materialcursocampe">
            ...
            <p className="blog-post-meta">Octubre 10, 2020 por Pablo Valencia</p>
      ...
      <div className="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3 espaciocpntenedortargetas-materialcursocampe">
      <div className="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden targeta1-materialdocumentocursocampe">
        <div className="my-3 p-3">
          <h2 className="display-5 titulo1-targetasfinales2-materialdocumentocampe">Maquina Pesticida</h2>
          <p className="lead parrafosdematerialcursocampe2">La fumigadora Royal Condor hace más óptimo el trabajo para el cuidado de tus cultivos.</p>
        </div>
        <div className="bg-dark box-shadow mx-auto targetasfinales-materialcursocampe"></div>
      </div>
      <div className="bg-primary mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden targeta1-materialdocumentocursocampe">
        <div className="my-3 py-3">
          <h2 className="display-5 titulo1-targetasfinales-materialdocumentocampe">Traje Recomendado</h2>
          <p className="lead parrafosdematerialcursocampe3">El siguiente traje se recomienda si se trabaja con pesticidas de alta influencia química.</p>
        </div>
        <div className="bg-light box-shadow mx-auto targetasfinales2-materialcursocampe"></div>
      </div>
    </div>
